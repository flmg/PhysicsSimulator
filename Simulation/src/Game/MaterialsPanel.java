...
public class MaterialsPanel {
	...
	public void render(Graphics g, TrueTypeFont font, FluidsHandler fluids) throws SlickException {

		// materials backgrounds
		Color col = new Color(0.3f, 0.3f, 0.3f, 1f);
		g.setColor(col);
		g.fillRect(0, 190, 100, 215);
		col = new Color(0.1f, 0.1f, 0.1f, 1f);
		g.setColor(col);
		g.fillRect(2, 192, 96, 211);
		...
		col = new Color(0.9f, 0f, 0f, 1f); //fire
		g.setColor(col);
